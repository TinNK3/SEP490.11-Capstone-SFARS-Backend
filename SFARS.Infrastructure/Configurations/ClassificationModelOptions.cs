...
public class ClassificationModelOptions
{
    ...
    /// Used as fallback when ClassMappingPath file does not exist yet.
    /// </summary>
    public string ClassMapping { get; set; } = string.Empty;

    /// <summary>
    /// Path to class_mapping.json file generated by the Python retrain pipeline.
    /// When present, this file takes priority over the ClassMapping string.
    /// Hot-swap will also reload mapping from this file.
    /// </summary>
    public string ClassMappingPath { get; set; } = string.Empty;
}