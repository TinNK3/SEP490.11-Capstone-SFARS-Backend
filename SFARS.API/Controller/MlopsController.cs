...
namespace SFARS.API.Controller.Admin
{
    ...
    public class MlopsController : ControllerBase
    {
        ...
        /// <summary>
        /// [Admin] Export human-verified training data for AI retraining.
        /// </summary>
        ...
        /// <summary>
        /// [Machine-to-Machine] MLOps pipeline fetches data using API Key instead of JWT.
        /// </summary>
        [AllowAnonymous]
        ...
        /// <summary>
        /// [Admin] Manually trigger the MLOps retrain pipeline (bypasses threshold check).
        /// </summary>
        ...
        public IActionResult TriggerRetrainAsync()
        {
            ...
            return Accepted(new { message = "Retrain pipeline has been queued." });
        }
    }
}