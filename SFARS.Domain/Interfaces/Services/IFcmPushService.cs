...
public interface IFcmPushService
{
    ...
    //Task SendToUsersWithoutLogAsync(IEnumerable<Guid> userIds, string title, string body, IDictionary<string, string>? data = null);
    //Task SendToUserWithoutLogAsync(Guid userId, string title, string body, IDictionary<string, string>? data = null);
}